...
public class Predator extends ReproductionAnimal {
	...
	public ReproductionAnimal getOffsping(ReproductionAnimal mate) {
		return new Predator(habitat,getDescription(),Trait.getDominantTrait(getTrait1(), mate.getTrait2()),
